...
export type CreateSnippetGraphQlMutation = (
  { __typename?: 'Mutation' }
  & { createSnippet: (
    { __typename?: 'Snippet' }
    & Pick<Snippet, 'id' | 'status' | 'title' | 'content' | 'description' | 'recommendations' | 'author'>
...
export type DeleteSnippetGraphQlMutation = (
  { __typename?: 'Mutation' }
  & { deleteSnippet?: Maybe<(
    { __typename?: 'Snippet' }
    & Pick<Snippet, 'id'>
...
export type UpdateSnippetGraphQlMutation = (
  { __typename?: 'Mutation' }
  & { updateSnippet?: Maybe<(
    { __typename?: 'Snippet' }
    & Pick<Snippet, 'id' | 'status' | 'title' | 'content' | 'description' | 'recommendations' | 'author'>
...
export type SnippetGraphQlQuery = (
  { __typename?: 'Query' }
  & { snippet?: Maybe<(
    { __typename?: 'Snippet' }
    & Pick<Snippet, 'id' | 'status' | 'title' | 'content' | 'description' | 'recommendations' | 'author'>
...
export type SnippetsGraphQlQuery = (
  { __typename?: 'Query' }
  & { snippets: Array<Maybe<(
    { __typename?: 'Snippet' }
    & Pick<Snippet, 'id' | 'status' | 'title' | 'content' | 'description' | 'recommendations' | 'author'>
    & { userLikes?: Maybe<Array<(
      { __typename?: 'UserLike' }
